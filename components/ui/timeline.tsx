...
const timelineContentVariants = cva('row-start-2 row-end-2 pb-4 sm:pb-6 text-muted-foreground', {
  variants: {
    side: {
...
const TimelineLine = React.forwardRef<HTMLHRElement, TimelineLineProps>(({className, done = false, ...props}, ref) => {
  return (
    <hr
      role="separator"
...
export {TimelineDot, TimelineItem, TimelineContent, TimelineHeading, TimelineLine};
