export type Skill = ProgrammingLanaguage | Framework | Database | Tool | Cloud | OperatingSystem;
...
export type Tool = 'Docker' | 'Kubernetes' | 'Git' | 'GitHub' | 'GitLab' | 'Jenkins' | 'Blender';
